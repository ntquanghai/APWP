...
def displayInfo(Tk, canvas):
    ...
    text6 = Label(Tk, bg = "#87CEFA", fg = "#FFFFFF", text = "Email:", font = ("Arial Bold", 16))
    canvas.create_window(58, 300, window = text6)
    text7 = Label(Tk, bg = "#87CEFA", fg = "#FFFFFF", text = "Salary:", font = ("Arial Bold", 16))
    canvas.create_window(61, 350, window = text7)
    text8 = Label(Tk, bg = "#87CEFA", fg = "#FFFFFF", text = "Shift:", font = ("Arial Bold", 16))
    canvas.create_window(53, 400, window = text8)
    text9 = Label(Tk, bg = "#87CEFA", fg = "#FFFFFF", text = "Years:", font = ("Arial Bold", 16))
    canvas.create_window(59, 450, window = text9)
    text10 = Label(Tk, bg = "#87CEFA", fg = "#FFFFFF", text = "Department:", font = ("Arial Bold", 16))
    canvas.create_window(89, 500, window = text10)
    text11 = Label(Tk, bg = "#87CEFA", fg = "#FFFFFF", text = "Position:", font = ("Arial Bold", 16))
    ...
    entry9 = Entry(Tk, bg = "#87CEFA", fg ="#000000", font = ("Arial Bold", 16), width = 20)
...
def editWindow():
    ...
    saveB = Button(root, bd = 1, bg = "#87CEFF", fg = "#FFFFFF", activebackground = "#B0E2FF", activeforeground = "#FFFFFF", font = ("Arial Bold", 16), text ="Add", 
                   width = 13)
    ...
    restoreB = Button(root, bd = 1, bg = "#87CEFF", fg = "#FFFFFF", activebackground = "#B0E2FF", activeforeground = "#FFFFFF", font = ("Arial Bold", 16), text ="Cancel", 
                      width = 13)
    ...
    promoteB = Button(root, bd = 1, bg = "#87CEFF", fg = "#FFFFFF", activebackground = "#B0E2FF", activeforeground = "#FFFFFF", font = ("Arial Bold", 16), text ="Cancel", 
                      width = 13)
    ...
    demoteB = Button(root, bd = 1, bg = "#87CEFF", fg = "#FFFFFF", activebackground = "#B0E2FF", activeforeground = "#FFFFFF", font = ("Arial Bold", 16), text ="Cancel", 
                     width = 13)
