...
def addWindow():
    ...
    addB = Button(root, bd = 1, bg = "#87CEFF", fg = "#FFFFFF", font = ("Arial Bold", 18), text ="Add", width = 15, command = add)
    ...
    cancelB = Button(root, bd = 1, bg = "#87CEFF", fg = "#FFFFFF", font = ("Arial Bold", 18), text ="Cancel", width = 15, command = root.destroy)
